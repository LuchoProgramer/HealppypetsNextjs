...
export default function VacunacionLanding() {
  ...
  const VACCINATION_SCHEDULE = [
    {
      age: "Mes y Medio",
      vaccines: "Primera dosis: Múltiple",
      price: "$20"
    },
    {
      age: "2 Meses",
      vaccines: "Segunda dosis: Múltiple",
      price: "$20"
    },
    {
      age: "3 Meses",
      vaccines: "Tercera dosis: Múltiple + Antirrábica",
      price: "$25"
    },
    {
      age: "Anual (Adultos)",
      vaccines: "Múltiple + Antirrábica + Tos de Perrera",
      price: "$20"
    }
  ];
  ...
  const TESTIMONIALS = [
    {
      ...
      text: "Rocky estaba asustado pero el veterinario fue muy paciente. Consulta completa y buenos consejos.",
      rating: 5
    },
    {
      name: "Luis Herrera",
      pet: "Toby (Labrador)",
      text: "Toby recibió todas sus vacunas aquí. El seguimiento ha sido excelente. Muy profesionales!",
      rating: 5
    }
  ];
  ...
  const FAQ_ITEMS = [
    {
      q: "¿A qué edad debo empezar a vacunar?",
      a: "Las vacunas inician desde el mes y medio de vida. Es crucial comenzar temprano para proteger a tu cachorro desde el principio."
    },
    {
      q: "¿Cuántas vacunas necesita mi mascota?",
      a: "De cachorro: 4-6 dosis en el primer año. De adulto: una vacuna múltiple anual + antirrábica."
    },
    {
      q: "¿Cuánto tiempo toma la vacunación?",
      a: "La consulta y vacunación toman aproximadamente 15-20 minutos."
    },
    {
      q: "¿Tiene efectos secundarios?",
      a: "Raramente. Puede haber letargo leve por 24-48 horas. Contacta si ves reacciones severas."
    },
    {
      q: "¿Las vacunas son obligatorias?",
      a: "La antirrábica es obligatoria por ley. Las demás son recomendadas pero esenciales para proteger a tu mascota."
    }
  ];
