  ...
  const TESTIMONIALS = [
    {
      ...
      text: "Rocky tenía problemas de piel. La consulta fue completa y con los productos recomendados está perfecto!",
      rating: 5
    },
    {
      name: "Carmen López",
      pet: "Michi (Gato Naranja)",
      text: "Michi estaba estresado. La veterinaria me dio consejos maravillosos. Ahora está tranquilo.",
      rating: 5
    }
  ];
  ...
  const FAQ_ITEMS = [
    {
      ...
      a: "Una consulta veterinaria cuesta $15. Incluye examen completo, diagnóstico y recomendaciones personalizadas."
    },
    {
      q: "¿Cuánto tiempo toma la consulta?",
      a: "Aproximadamente 30-45 minutos, dependiendo de la complejidad del caso."
    },
    {
      q: "¿Qué debo llevar a la consulta?",
      a: "Trae el carnet de vacunación (si existe), historial médico previo, y anota los síntomas que ha presentado."
    },
    {
      q: "¿Mi mascota está asustada, qué hago?",
      a: "Carla es muy paciente y cariñosa. Tu mascota recibirá un trato especial. Puedes quedarte durante la consulta."
    },
    {
      q: "¿Venden medicamentos en consulta?",
      a: "Sí, tenemos farmacia veterinaria completa con medicamentos, suplementos y productos recomendados por Carla."
    }
  ];
