      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3">
              <a
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && window.gtag) {
                    window.gtag('event', 'footer_click_facebook', {
              ...
              <a
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && window.gtag) {
                    window.gtag('event', 'footer_click_instagram', {
                      event_category: 'footer_social',
              ...
              <a
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && window.gtag) {
                    window.gtag('event', 'footer_click_tiktok', {
                      event_category: 'footer_social',
                      event_label: 'TikTok',
                    });
                  }
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start space-x-2">
                ...
                <a
                  ...
                  onClick={() => {
                    if (typeof window !== 'undefined' && window.gtag) {
                      window.gtag('event', 'footer_click_llamar', {
              ...
              <li className="flex items-start space-x-2">
                ...
                <a
                  ...
                  onClick={() => {
                    if (typeof window !== 'undefined' && window.gtag) {
                      window.gtag('event', 'footer_click_whatsapp', {
                        event_category: 'footer_contact',
        ...
        <div className="mt-12 text-center bg-gradient-to-r from-[#F2C9E7]/10 to-[#F2C2EA]/10 rounded-2xl p-8 border border-[#F2C2EA]/20">
          ...
          <a
            ...
            onClick={() => {
              if (typeof window !== 'undefined' && window.gtag) {
                window.gtag('event', 'footer_click_agendar_primera_cita', {
  ...
  return (
    <div className={`fixed bottom-20 lg:bottom-6 right-4 lg:right-6 z-50 transition-all duration-500 ${
      ...
      <a
        ...
        onClick={() => {
          if (typeof window !== 'undefined' && window.gtag) {
            window.gtag('event', 'whatsapp_flotante_click', {
              event_category: 'whatsapp_float',
