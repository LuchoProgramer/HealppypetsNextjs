  ...
  return (
    <>
      ...
      <a
        ...
        className={`hidden lg:inline-flex fixed bottom-24 md:bottom-6 right-6 z-40 group transition-all duration-300 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"
          }`}
      ...
      <button
        ...
        className={`fixed bottom-6 left-6 z-40 bg-primary-500 hover:bg-primary-600 text-white w-12 h-12 rounded-full shadow-strong flex items-center justify-center transition-all duration-300 hover:scale-110 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-20 opacity-0"
          }`}
